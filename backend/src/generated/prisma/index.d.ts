...
export namespace Prisma {
  ...
  */
  ...
  export type ProducaoOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id_producao" | "id_produto" | "id_usuario" | "tipo" | "quantidade" | "data_movimentacao", ExtArgs["result"]["producao"]>
  ...
  interface ProducaoFieldRefs {
    ...
    readonly data_movimentacao: FieldRef<"Producao", 'DateTime'>
  }
  ...
  export type ProducaoWhereInput = {
    ...
    data_movimentacao?: DateTimeFilter<"Producao"> | Date | string
  ...
  export type ProducaoScalarWhereWithAggregatesInput = {
    ...
    data_movimentacao?: DateTimeWithAggregatesFilter<"Producao"> | Date | string
  }
